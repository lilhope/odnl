...
#RNN related
config.RNN = edict()
config.RNN.VOCAB_SIZE = 10342
config.RNN.NUM_EMBED = 300
config.RNN.USE_W2V = True
...
dataset.refer = edict()
dataset.refer.dataset = 'refer'
dataset.refer.subset = 'refcoco'
dataset.refer.split = 'google'
dataset.refer.root_path = 'data'
dataset.refer.NUM_CLASSES = 3
